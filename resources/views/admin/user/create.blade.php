...
<section role="main">
      <div class="row">
            <div class="col-lg-12">
                  <section class="panel">
                        <form class="form-horizontal form-bordered" method="POST" action="{{ route('user.store') }}">
                              @csrf
                              <header class="panel-heading">
                                    ...
                                    <h2 class="panel-title">Tambah Data Master User</h2>
                              </header>
                                    ...
                                    <div class="form-group @error('role') has-error @enderror">
                                          ...
                                          <div class="col-md-6">
                                                <select name="role" id="role" class="form-control" required>
                                                      ...
                                                      <option value="1" {{ old('role') == '1' ? 'selected' : '' }}>Viewer</option>
                                                </select>
                                                @error('role')
