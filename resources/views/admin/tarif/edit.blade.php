...
<section role="main">
      <div class="row">
            <div class="col-lg-12">
                  <section class="panel">
                        <form class="form-horizontal form-bordered" method="POST" action="{{ route('tarif.update', $tarif->id_tarif) }}">
                              @csrf
                              @method('put')
                              <header class="panel-heading">
                                    ...
                                    <h2 class="panel-title">Perbaruhi Data Master Tarif</h2>
                              </header>
                              <div class="panel-body">
                                    <div class="form-group @error('daya') has-error @enderror">
                                          ...
                                          <div class="col-md-6">
                                                <input type="text" name="daya" id="daya" class="form-control" value="{{ old('daya', number_format($tarif->daya, 0, '.', ',')) }}" autofocus required>
                                                @error('daya')
                                    ...
                                    <div class="form-group @error('tarifperkwh') has-error @enderror">
                                          ...
                                          <div class="col-md-6">
                                                <input type="text" name="tarifperkwh" id="tarifperkwh" class="form-control" value="{{ old('tarifperkwh', number_format($tarif->tarifperkwh, 0, '.', ',')) }}" required>
                                                @error('tarifperkwh')
